...
- `homebrew-tap/`: git submodule of the Homebrew tap repo `doggy8088/homebrew-dedent-paste` (formula is generated by cargo-dist; caveats are re-added by the tap's own workflow).
